...
def feedforward(regrasp_status):
    if regrasp_status.data is True:
        print 'looping!'
        ...
        gripper = 227 #length from parallel gripper base to 2-finger tip excluding wire mount
...
def dynamixel_control():
    ...
    rospy.Subscriber('/regrasp_status', Bool, feedforward)
    rospy.spin()
